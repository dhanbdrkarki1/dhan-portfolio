...
const articles: Article[] = [
  {
    ...
    description: 'A practical guide to containerizing applications with Docker, including best practices for multi-stage builds and optimization.',
    category: 'architecture',
    date: '2024-12-15',
    readTime: '8 min',
    metrics: [
      { label: 'Complexity', value: 'Beginner' },
      { label: 'Tools', value: 'Docker' },
    ],
  },
  {
    id: 'art-2',
    title: 'CI/CD with GitHub Actions',
    description: 'Building automated deployment pipelines using GitHub Actions, from basic workflows to advanced deployment strategies.',
    category: 'performance',
    date: '2024-12-01',
    readTime: '10 min',
    metrics: [
      { label: 'Platform', value: 'GitHub' },
      { label: 'Type', value: 'Tutorial' },
    ],
  },
  {
    id: 'art-3',
    title: 'Terraform Basics: Infrastructure as Code',
    description: 'Understanding Terraform fundamentals and using it to manage AWS infrastructure efficiently.',
    category: 'architecture',
    date: '2024-11-20',
    readTime: '12 min',
    metrics: [
      { label: 'Cloud', value: 'AWS' },
      { label: 'Tool', value: 'Terraform' },
    ],
  },
  {
    id: 'art-4',
    title: 'More Articles Coming Soon',
    description: 'Stay tuned for more technical articles about DevOps practices, cloud infrastructure, and automation strategies.',
    category: 'architecture',
    date: '2025-01-01',
    readTime: '5 min',
  },
